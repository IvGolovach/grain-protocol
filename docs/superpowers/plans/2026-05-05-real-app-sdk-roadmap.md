...
| 7 | Developer DX closeout | PR open | `codex/developer-dx-closeout-step7` | #55 | | `scripts/sdk/doctor` warning-aware readiness check; docs/LLM/workflow guard checks; diff/ledger checks | Pending PR CI/review after same-task doctor/docs review fix |
