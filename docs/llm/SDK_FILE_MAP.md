...
9. `docs/human/sdk/scan-quickstart.md`
...
17. `core/rust/grain-client-core/src/*`
...
18. `core/rust/uniffi-bindgen`, `scripts/sdk/*generated_bindings.sh`, and `sdk/generated/README.md`
...
21. `core/rust/grain-client-wasm/**`
...
23. `docs/human/sdk/impossible-misuse.md`
   - Human-readable reject-path summary.
24. `docs/human/sdk/errors.md`
   - Human-readable error contract.
25. `core/ts/grain-sdk/src/*`
   - Core SDK implementation modules.
26. `core/ts/grain-sdk-ai/src/*`
