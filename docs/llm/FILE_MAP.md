...
9. `core/rust/`, `runner/typescript/`, `core/`, `sdk/`
   - Implementations. They must conform to the contract above.
10. `.github/workflows/`, `.githooks/*`, `scripts/setup_local_hygiene.sh`, `tools/ci/check_history_hygiene.py`, `MIGRATION.md`, `TOR-PORTABILITY-A01.md`, `docs/human/github-hardening.md`, `docs/human/portability-pack.md`, `docs/human/porting-grain.md`
