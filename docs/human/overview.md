...
The core rules are general-purpose.
The shipped schema profile is food-first.

## What lives where

- `spec/*`: normative rules and machine-readable schemas
- `conformance/*`: executable release gate
...
- Maintaining the repo: `docs/human/maintainer-start-here.md`
