...
use grain_client_core::scan_preview;
use workflow_fixture::{
    load_scan_preview_fixtures, resolve_string_ref, CosePresence, StoreMutation, WorkflowName,
};
...
fn scan_preview_matches_client_workflow_fixtures() -> Result<(), String> {
    ...
    for fixture in fixtures {
        ...
        assert_eq!(
            preview.status,
            fixture.expect.status.as_status(),
            "{} status mismatch",
            fixture.fixture_id
        );
